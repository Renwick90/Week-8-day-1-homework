...
describe('bank', function(){
  ...
  it("should increace account balance by %2", function(){
    var bank = new Bank();
    var account1 = new Account({owner:'Jay',amount:100, type:'business'});
    var account2 = new Account({owner:'Val',amount:100, type:'business'});
    var account3 = new Account({owner:'Kieth',amount:100, type:'personal'});
    bank.addAccount(account1);
    bank.addAccount(account2);
    bank.addAccount(account3);
    bank.payInterest();
    assert.equal( 306, bank.totalCash());
  })
})
